---
date: '2026-05-03T23:39:32-04:00'
draft: false
title: "Multimode Services Provided by the Quadnet Network"
tags: ["Multimode", "connect"]
categories: ["tech", "M17", "DMR"]
---
...
Though the connections shown below have more detail than the simple list of connections in the Connection post there are too many options to list and explain.

- ***If assistance is needed for connecting to RadioSC please contact us on our [Discord Server](https://discord.gg/aujUBDebb) so that we can provide individualized assistance.***
...
## Connecting to RadioSC via Yaesu System Fusion (YSF) via a YSF radio with a hotspot
...
## Connecting to RadioSC via a D-STAR radio with a hotspot
...
## Connecting to RadioSC via a M17 radio with a hotspot, et al
